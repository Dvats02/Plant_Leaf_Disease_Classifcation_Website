...
function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!backendUrl) {
        console.error(
          'Backend URL is not configured. Please set REACT_APP_API_URL in your .env file.'
        )
        throw new Error(
          'Backend URL is not configured. Check console for details.'
        )
      }
      ...
      if (data && data.prediction) {
        ...
        console.error(
          'Backend response is missing the "prediction" key. Response:',
          data
        )
  ...
  return (
    <div className="app-container">
      ...
      <main className="content-area">
        <div className="upload-section">
          ...
          <p className="instructions">
            Take a clear photo of a plant leaf and upload it to identify if it's
            healthy or affected by disease.
          </p>
            ...
            <div className={`result-section ${resultClass}`}>
              {error ? (
                ...
                <div className="result-display">
                  ...
                  <p className="result-text">{result?.class}</p>
                  {result?.class && (
                    <div className="recommendation">
                      {result?.class.toLowerCase().includes('healthy') ? (
                        <p>
                          Your plant appears healthy! Continue with your current
                          care routine.
                        </p>
                      ) : (
                        <p>
                          Disease detected. Consider treatment options
                          appropriate for the identified condition.
                        </p>
                      )}
                    </div>
                  )}
      ...
      <footer className="app-footer">
        <p>
          LeafScan &copy; {new Date().getFullYear()} • Upload clear, well-lit
